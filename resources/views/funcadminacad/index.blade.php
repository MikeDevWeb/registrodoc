                ...
                <div class="card">
                    <div class="card-header text-sm">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                {{ __('Función administrativa / academica') }}
                            </span>
                                ...
                                <table id="tablita" class="table table-striped table-hover text-xs w-100">
                                    ...
                                    <tbody>
                                        @foreach ($funcadminacads as $funcadminacad)
                                            ...
                                            <td >{{ $funcadminacad->datospersona->nombre }} {{ $funcadminacad->datospersona->apellidoPaterno }} {{ $funcadminacad->datospersona->apellidoMaterno }}</td>
                                            <td >{{ $funcadminacad->user->name }}</td>
                                            <td >{{ $funcadminacad->fecharegistro }}</td>
