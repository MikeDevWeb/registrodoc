                                ...
                                <table id="tablita" class="table table-striped table-hover text-xs">
                                    ...
                                    <tbody>
                                        @foreach ($formpostgrados as $formpostgrado)
                                            <tr>
                                                <td>{{ ++$i }}</td>
                                                <td >{{ $formpostgrado->datospersona->nombre }} {{ $formpostgrado->datospersona->apellidoPaterno }} {{ $formpostgrado->datospersona->apellidoMaterno }}</td>
                                                ...
                                                <td>
                                                    <form action="{{ route('formpostgrados.destroy', $formpostgrado->id) }}" method="POST">
                                                        <div class="btn-group">
                                                            <a class="btn-xs btn-primary text-center" href="{{ route('formpostgrados.show', $formpostgrado->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Revisar') }}</a>
                                                            <a class="btn-xs btn-success text-center" href="{{ route('formpostgrados.edit', $formpostgrado->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Modificar') }}</a>
                                                            @csrf
                                                            @method('DELETE')
