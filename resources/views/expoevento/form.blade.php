    ...
    <div class="col-md-12 row">
        <div class="col-md-6">
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <select class="form-control text-sm @error('datospersona_id') is-invalid @enderror" name="datospersona_id" id="datospersona_id">
                    ...
                    @foreach ($datospersonas as $datospersona)
                        @php
                            $isRegistered = \App\Models\Expoevento::where('datospersona_id', $datospersona->id)
                                ->where('id', '<>', optional($expoevento)->id)
                                ->exists();
                        @endphp
                        <option value="{{ $datospersona->id }}" {{ $datospersona->id == (old('datospersona_id', $expoevento?->datospersona_id) ?: '') ? 'selected' : '' }} {{ $isRegistered ? 'disabled' : '' }}>
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="institucion" class="form-control text-sm @error('institucion') is-invalid @enderror" value="{{ old('institucion', $expoevento?->institucion) }}" id="institucion" placeholder="">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <select class="form-control text-sm @error('tipoevento') is-invalid @enderror" name="tipoevento" id="tipoevento">
                    <option value="Científico" {{ 'Científico' == (old('tipoevento', $expoevento?->tipoevento) ?: '') ? 'selected' : '' }}>Científico</option>
                </select>
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="tematica" class="form-control text-sm @error('tematica') is-invalid @enderror" value="{{ old('tematica', $expoevento?->tematica) }}" id="tematica" placeholder="">
        ...
        <div class="col-md-6">
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="date" name="fechainicio" class="form-control text-sm @error('fechainicio') is-invalid @enderror" value="{{ old('fechainicio', $expoevento?->fechainicio) }}" id="fechainicio" placeholder="">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="date" name="fechafin" class="form-control text-sm @error('fechafin') is-invalid @enderror" value="{{ old('fechafin', $expoevento?->fechafin) }}" id="fechafin" min="{{ $expoevento?->fechainicio ?? '' }}">
                @error('fechafin')
                    <div class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></div>
                @enderror
                @if($expoevento?->fechainicio && $expoevento?->fechainicio > $expoevento?->fechafin)
                    <span class="text-danger">La fecha final debe ser mayor que la fecha inicial.</span>
                @elseif($expoevento?->fechainicio && $expoevento?->fechainicio < $expoevento?->fechafin)
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="duracion" class="form-control text-sm @error('duracion') is-invalid @enderror" value="{{ old('duracion', $expoevento?->duracion) }}" id="duracion" placeholder="">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input readonly required type="text" name="fecharegistro" class="form-control text-sm @error('fecharegistro') is-invalid @enderror" value="{{ old('fecharegistro', $expoevento?->fecharegistro ?? \Carbon\Carbon::now()->format('Y-m-d')) }}" id="fecharegistro">
