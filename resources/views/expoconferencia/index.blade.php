                                    ...
                                    <tbody>
                                        @foreach ($expoconferencias as $expoconferencia)
                                            <tr>
                                                ...
                                                <td >{{ $expoconferencia->datospersona->nombre }} {{ $expoconferencia->datospersona->apellidoPaterno }} {{ $expoconferencia->datospersona->apellidoMaterno }}</td>
                                            ...
                                            <td >{{ $expoconferencia->user->name }}</td>
                                            <td >{{ $expoconferencia->fecharegistro }}</td>
                                                <td>
                                                    <form action="{{ route('expoconferencias.destroy', $expoconferencia->id) }}" method="POST">
                                                        <div class="btn-group">
                                                            <a class=" btn-xs btn-primary text-center" href="{{ route('expoconferencias.show', $expoconferencia->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Revisar') }}</a>
                                                            <a class=" btn-xs btn-success text-center" href="{{ route('expoconferencias.edit', $expoconferencia->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Modificar') }}</a>
                                                            @csrf
                                                            @method('DELETE')
