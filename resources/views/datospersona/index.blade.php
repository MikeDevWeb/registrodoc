                                            ...
                                            <td>
                                                <form action="{{ route('datospersonas.destroy', $datospersona->id) }}" method="POST">
                                                    <div class="btn-group">
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="text-xs btn-danger btn-xs" onclick="event.preventDefault(); confirm('Esta de acuerdo con eliminar?') ? this.closest('form').submit() : false;"><i class="fa fa-fw fa-trash"></i> {{ __('Eliminar') }}</button>
                                                    </div>
