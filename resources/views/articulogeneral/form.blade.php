    ...
    <div class="col-md-12 row">
        ...
        <div class="col-md-6">
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <select class="form-control text-sm @error('datospersona_id') is-invalid @enderror" name="datospersona_id" id="datospersona_id">
                    ...
                    @foreach ($datospersonas as $datospersona)
                        @php
                            $isRegistered = \App\Models\Articulogeneral::where('datospersona_id', $datospersona->id)
                                ->where('id', '<>', optional($articulogeneral)->id)
                                ->exists();
                        @endphp
                        <option value="{{ $datospersona->id }}" {{ $datospersona->id == (old('datospersona_id', $articulogeneral?->datospersona_id) ?: '') ? 'selected' : '' }} {{ $isRegistered ? 'disabled' : '' }}>
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="nombrearticulo" class="form-control text-sm @error('nombrearticulo') is-invalid @enderror" value="{{ old('nombrearticulo', $articulogeneral?->nombrearticulo) }}" id="nombrearticulo" placeholder="">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="anio" class="form-control text-sm @error('anio') is-invalid @enderror" value="{{ old('anio', $articulogeneral?->anio) }}" id="anio" placeholder="">
                {!! $errors->first('anio', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
            </div>
            <div class="form-group mb-2 mb20 text-sm">
                <label for="organopublicacion" class="form-label text-sm">{{ __('Órgano publicación') }}</label>
                <input type="text" name="organopublicacion" class="form-control text-sm @error('organopublicacion') is-invalid @enderror" value="{{ old('organopublicacion', $articulogeneral?->organopublicacion) }}" id="organopublicacion" placeholder="">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="autor" class="form-control text-sm @error('autor') is-invalid @enderror" value="{{ old('autor', $articulogeneral?->autor) }}" id="autor" placeholder="">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input type="text" name="coautor" class="form-control text-sm @error('coautor') is-invalid @enderror" value="{{ old('coautor', $articulogeneral?->coautor) }}" id="coautor" placeholder="">
            ...
            <div class="form-group mb-2 mb20 text-sm">
                ...
                <input readonly required type="text" name="fecharegistro" class="form-control text-sm @error('fecharegistro') is-invalid @enderror" value="{{ old('fecharegistro', $articulogeneral?->fecharegistro ?? \Carbon\Carbon::now()->format('Y-m-d')) }}" id="fecharegistro">
