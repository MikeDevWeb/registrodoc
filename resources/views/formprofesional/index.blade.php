                    ...
                    <div id="tablita_wrapper ">
                        <div class="card-body text-xs bg-white">
                            <div class="table-responsive">
                                <table id="tablita" class="table text-xs table-striped table-hover">
                                    <thead class="thead">
                                        <tr>
                                            <th>#</th>
                                    ...
                                    <tbody>
                                        @foreach ($formprofesionals as $formprofesional)
                                            ...
                                            <td >{{ $formprofesional->datospersona->nombre }} {{ $formprofesional->datospersona->apellidoPaterno }} {{ $formprofesional->datospersona->apellidoMaterno }}</td>
                                            ...
                                            <td >{{ $formprofesional->user->name }}</td>
                                                ...
                                                <td>
                                                    <form class="" action="{{ route('formprofesionals.destroy', $formprofesional->id) }}" method="POST">
                                                        <div class="btn-group text-center text-xs">
                                                            <a class="btn-xs btn-primary text-center" href="{{ route('formprofesionals.show', $formprofesional->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Revisar') }}</a>
                                                            <a class="btn-xs btn-success text-center" href="{{ route('formprofesionals.edit', $formprofesional->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Modificar') }}</a>
                                                            @csrf
                                                            @method('DELETE')
