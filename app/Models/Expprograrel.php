 ...
 */
class Expprograrel extends Model
{
     ...
     */
    protected $fillable = ['institucion', 'cargoactividad', 'fechainicio', 'fechafin', 'duracion', 'datospersona_id', 'user_id'];
