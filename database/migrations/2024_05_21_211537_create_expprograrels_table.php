...
return new class extends Migration
{
    ...
    {
        Schema::create('expprograrels', function (Blueprint $table) {
            $table->id();
            $table->string('institucion',120) ->pattern('[a-zA-Z]+') -> required;
            $table->string('cargoactividad',120) ->pattern('[a-zA-Z]+') -> comment('indique cargo o actividad') ->  required;
    ...
    {
        Schema::dropIfExists('expprograrels');
    }
};
